...
<body>
    ...
    <div class="container">
        ...
        <h2 class="text-center">BBVA</h2>

        <div class="row">
            <div class="col-md-7 col-md-offset-3">
                <div class="panel panel-default credit-card-box">
                    <div class="panel-heading display-table">
                        <h3 class="panel-title text-center"><strong>Tarjeta Débito/Crédito</strong></h3>
                    </div>
                        ...
                        <form role="form" action="/stripe" method="post" class="require-validation"
                            ...
                            <div class='form-row row'>
                                <div class='col-xs-12 form-group required'>
                                    <label class='control-label'>Nombre del titular de la tajeta</label>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <button class="btn btn-primary btn-lg btn-block" type="submit">Paga
                                        Ahora <span id="Precio">($200)</span></button>
                                </div>
                            </div>
...
<script type="text/javascript">
    let precio = 0;
    let comprar = document.getElementById("total");
    ...
    precioDiv.innerText = "" + Number(precio) + "€";
    comprar.value = Number(precio);
    $(function() {
